...
xaringanExtra::use_logo(
  image_url = "img/00/logo_uni_elixir.png",
  height = "30px",
...
xaringanExtra::use_logo(
  image_url = "https://github.com/ULHPC/documents/blob/master/logos/logo_hpc-shool2021.png",
  width = "50px",
  height = "50px",
  position = xaringanExtra::css_position(bottom = "1em", left = "1em"),
...
.pull-left[
- Beginner user, check out [this lecture](https://rworkshop.uni.lu/lectures/lecture01_intro.html#10)
![](img/intro_p9.png)
]

.pull-right[
- Advanced user, interested in programming, check out [this lecture](https://rworkshop.uni.lu/lectures/lecture12_tidyeval.html)
...
```{r, echo = FALSE}
htmltools::img(src = "https://rworkshop.uni.lu/lectures/img/img/news_tidyverse_pkg_in_processes.png",
...
- [`drake`](https://github.com/ropensci/drake), is the most used workflow manager for .Large[`R`]. 1,300 `r fontawesome::fa("star", fill = "gold")` on Github 
